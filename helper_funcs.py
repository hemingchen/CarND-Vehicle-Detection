...
def extract_features_from_one_img(
        img,
        color_space='RGB',
        spatial_size=(32, 32),
        hist_bins=32,
...
def extract_features_from_multiple_imgs(
        img_paths,
        color_space='RGB',
        spatial_size=(32, 32),
        hist_bins=32,
    ...
    for img_path in img_paths:
        # Read in one image and extract features
        img_features = extract_features_from_one_img(
